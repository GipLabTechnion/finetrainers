...
DATA_ROOT="/workspace/datasets/v2v/"
...
VALIDATION_VIDEOS="/workspace/datasets/v2v/test/video_68.mp4"
  ...
  for lr_schedule in "${LR_SCHEDULES[@]}"; do
    for optimizer in "${OPTIMIZERS[@]}"; do
      for steps in "${MAX_TRAIN_STEPS[@]}"; do
        output_dir="./cogvideox-v2v_lora__optimizer_${optimizer}__steps_${steps}__lr-schedule_${lr_schedule}__learning-rate_${learning_rate}/"
